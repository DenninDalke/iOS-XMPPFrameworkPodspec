...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of XMPPFramework in Markdown format.
  ...
  # Or just: s.author    = "Robbie Hanson"
  # s.authors            = { "Robbie Hanson" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Robbie Hanson"
  ...
  s.source_files  = "Authentication", "Categories", "Core", "Extensions", "Utilities", "Vendor"
